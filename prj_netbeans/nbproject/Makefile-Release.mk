...
${OBJECTDIR}/_ext/1360937237/cAppararence.o: ../src/cAppararence.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/cAppararence.o ../src/cAppararence.cpp

${OBJECTDIR}/_ext/1360937237/cPeca.o: ../src/cPeca.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/cPeca.o ../src/cPeca.cpp

${OBJECTDIR}/_ext/1360937237/imageloader.o: ../src/imageloader.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/imageloader.o ../src/imageloader.cpp

${OBJECTDIR}/_ext/1360937237/cTexture.o: ../src/cTexture.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/cTexture.o ../src/cTexture.cpp

${OBJECTDIR}/_ext/1360937237/cGame.o: ../src/cGame.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/cGame.o ../src/cGame.cpp

${OBJECTDIR}/_ext/1360937237/cBoard.o: ../src/cBoard.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360937237
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360937237/cBoard.o ../src/cBoard.cpp
